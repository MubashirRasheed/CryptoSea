...
import { NFTCard, Loader, Buttonn, Button, Modal } from '../components';
...
const NFTDetails = () => {
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCenter sm:px-4 p-12 vorder-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-gray-3 border-nft-gray-1 flex -flex-row">
